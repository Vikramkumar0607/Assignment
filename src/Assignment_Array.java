...
//1D Array Subjects of semester
String[] Subject1= {"Mathematics I","Mathematics II","Data Structures","Algorithms","Probability & Stats"};
String[] Subject2= {"Physics","Mechanics","Discrete Mathematics","Computer Networks","Machine Learning"};
String[] Subject3= {"Chemistry","Environmental Sci","Digital Electronics","Database System","Compiler Design"};
